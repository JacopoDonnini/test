...
function cleanMeshForExport(mesh) {
  ...
  // Keep export repair conservative: only weld/dedupe/degenerate cleanup.
  // Aggressive non-manifold edge pruning can remove valid engraving features.
...
document.getElementById('downloadBtn').addEventListener('click', () => {
  ...
  lines.push(`# export_repair: weld+dedupe+degenerate_cleanup`);
